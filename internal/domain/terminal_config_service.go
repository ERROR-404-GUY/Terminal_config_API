...
func (s *terminalConfigService) CreateTerminal(ctx context.Context, terminal *Terminal) error {
	if terminal.TID != "" {
		return errors.New("TID is generated by system, cannot be set by user")
	} else {
	...
	if terminal.ActivationCode != "" {
		return errors.New("activation code is generated by system, cannot be set by user")
	} else {
		terminal.ActivationCode = GenerateActivationCode()
	}
	if terminal.SerialNumber != "" {
		return errors.New("serial number is generated by system, cannot be set by user")
	} else {
